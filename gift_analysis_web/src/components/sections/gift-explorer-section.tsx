...
export function GiftExplorerSection({ gifts, badgeMap, onOpenReview, onFilterDrillDown, onResetFilters }: GiftExplorerSectionProps) {
    ...
    <section id="gift-explorer" className="flex scroll-mt-44 flex-col gap-4">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="section-copy">当前筛选结果会同步更新下面的礼物卡片，你可以继续按玩法缩小范围，或直接把礼物送去复核。</p>
        </div>
...
function InfoPill({ icon: Icon, label }: { icon: typeof Boxes; label: string }) {
  return (
